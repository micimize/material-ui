...
|:-----|:-----|:--------|:------------|
| <span class="prop-name">ModalBackdropComponent</span> | <span class="prop-type">union:&nbsp;string&nbsp;&#124;<br>&nbsp;func&nbsp;&#124;<br>&nbsp;object<br> | <span class="prop-default">ModalBackdrop</span> | A backdrop component. This property enables custom backdrop rendering. |
| <span class="prop-name">ModalBackdropProps</span> | <span class="prop-type">object |   | Properties applied to the [`ModalBackdrop`](/api/backdrop) element. |
...
| <span class="prop-name">disableModalBackdropClick</span> | <span class="prop-type">bool | <span class="prop-default">false</span> | If `true`, clicking the backdrop will not fire any callback. |
...
| <span class="prop-name">hideModalBackdrop</span> | <span class="prop-type">bool | <span class="prop-default">false</span> | If `true`, the backdrop is not rendered. |
...
| <span class="prop-name">onModalBackdropClick</span> | <span class="prop-type">func |   | Callback fired when the backdrop is clicked. |
